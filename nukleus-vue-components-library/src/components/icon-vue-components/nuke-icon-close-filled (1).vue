<template>
  <svg fill="none" height="32"
    ...
    <defs>
      <clipPath id="master_svg0_134_11568">
        <rect height="32" rx="0" width="32" x="0" y="0"/>
      </clipPath>
    </defs>
    <g clip-path="url(#master_svg0_134_11568)">
      <g>
        <path
      ...
      <g style="opacity:0;">
        <path d="M14.4,16L9,10.6L10.6,9L16,14.4L21.4,9L23,10.6L17.6,16L23,21.4L21.4,23L16,17.6L10.6,23L9,21.4L14.4,16Z"
              fill="currentColor" fill-opacity="1"/>
      </g>
      <g></g>
    </g>
